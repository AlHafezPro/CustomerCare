...
Const ColStrNo = 2
Const ColStrName = 3
Dim RsNameStr As New ADODB.Recordset

Function FillStrNo() As String
StrNo = ""
With MsflexGrid1
    For i = 1 To .Rows - 1
    .Row = i
    If .RowData(.Row) = 1 Then
        StrNo = StrNo & "-" & .TextMatrix(.Row, ColStrNo)
    End If
    Next
End With
FillStrNo = Mid(StrNo, 2)
End Function
...
With MsflexGrid1
    ...
    If Rs.RecordCount > 0 Then
        ...
        Do While Not Rs.EOF
            ...
            .RowData(Vrow) = 0
            .TextMatrix(Vrow, ColStrNo) = Rs!StrNo
            .TextMatrix(Vrow, ColStrName) = Rs!StrName
            Rs.MoveNext
        Loop
    End If
End With
...
'    Sqltext = "Delete From X33 Where Code=2"
'    Dstock.Con.Execute (Sqltext)
    Sqltext = "Select StrNo , StrName From NameStr  Order By Strno"
    Set RsNameStr = de.con.Execute(Sqltext)
    FillGrid RsNameStr
    FillFormatString
End Sub
