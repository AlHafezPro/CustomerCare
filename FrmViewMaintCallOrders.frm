   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button1 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Object.ToolTipText     =   " —ÕÌ· «·ÿ·»«  «·„ƒﬁ Â «·„ÕœœÂ"
            ImageIndex      =   14
         EndProperty
...
If ChkAllOrders.Value Then
    ChkAllOrders.Caption = "«·ÿ·»«  «·„—Õ·Â"
    Toolbar1.Buttons(1).Enabled = False
Else
    ChkAllOrders.Caption = "«·ÿ·»«  «·„ƒﬁ Â"
...
If KeyCode = vbKeyDelete Then
    If MsgBox("Â· √‰  „ √ﬂœ „‰ ⁄„·Ì… «·Õ–›", vbYesNo + vbDefaultButton2, "Õ–› «·ÿ·»«  «·„Õœœ…") = vbYes Then
        If .Row >= .RowSel Then
            FirstRow = .Row
            LastRow = .RowSel
        Else
...
If MsgBox("Â· «‰  „ √ﬂœ „‰  —ÕÌ· «·ÿ·»«  «·„ƒﬁ Â «·„ÕœœÂ ≈·Ï „·› «·‘ﬂ«ÊÏ ø", vbQuestion + vbYesNo + vbDefaultButton2, " —ÕÌ· «·ÿ·»«  «·„ƒﬁ Â «·„ÕœœÂ") = vbYes Then
