...
Begin VB.Form frmReparation_new 
   ...
   Begin TabDlg.SSTab SSTabRep 
      ...
      EndProperty
      TabCaption(0)   =   "»Ì«‰«  «·≈’·«Õ"
      TabPicture(0)   =   "frmReparation_new.frx":0000
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "CmdDelete"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "CmdSave"
      Tab(0).Control(1).Enabled=   0   'False
      Tab(0).Control(2)=   "cmdDiscount"
      Tab(0).Control(2).Enabled=   0   'False
      Tab(0).Control(3)=   "SSFrameModel"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "SSFrameRepInfo"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "SSFrameDip"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).ControlCount=   6
      TabCaption(1)   =   "«·√⁄ÿ«·"
      TabPicture(1)   =   "frmReparation_new.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "SSFrameRep"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "«·„Ê«œ"
      TabPicture(2)   =   "frmReparation_new.frx":0038
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "SSFramePiecesTab"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "«·„Ê«œ -2"
      TabPicture(3)   =   "frmReparation_new.frx":0054
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "LDealerPrice"
      Tab(3).Control(0).Enabled=   0   'False
      Tab(3).Control(1)=   "Label6(1)"
      Tab(3).Control(1).Enabled=   0   'False
      Tab(3).Control(2)=   "Label6(2)"
      Tab(3).Control(2).Enabled=   0   'False
      Tab(3).Control(3)=   "LPrice"
      Tab(3).Control(3).Enabled=   0   'False
      Tab(3).Control(4)=   "LBalance"
      Tab(3).Control(4).Enabled=   0   'False
      Tab(3).Control(5)=   "LStkName"
      Tab(3).Control(5).Enabled=   0   'False
      Tab(3).Control(6)=   "Label6(11)"
      Tab(3).Control(6).Enabled=   0   'False
      Tab(3).Control(7)=   "Label6(10)"
      Tab(3).Control(7).Enabled=   0   'False
      Tab(3).Control(8)=   "Label6(9)"
      Tab(3).Control(8).Enabled=   0   'False
      Tab(3).Control(9)=   "Label6(8)"
      Tab(3).Control(9).Enabled=   0   'False
      Tab(3).Control(10)=   "FlexGrid"
      Tab(3).Control(10).Enabled=   0   'False
      Tab(3).Control(11)=   "FrmePieces"
      Tab(3).Control(11).Enabled=   0   'False
      Tab(3).Control(12)=   "TxtStkQty"
      Tab(3).Control(12).Enabled=   0   'False
      Tab(3).Control(13)=   "TxtStkName"
      ...
      Begin Threed.SSFrame SSFrameDip 
         ...
         Begin MSDataListLib.DataCombo DcboClientKind 
            Bindings        =   "frmReparation_new.frx":0070
            Height          =   405
            Left            =   150
            TabIndex        =   27
            Top             =   210
         ...
         End
      End
      Begin Threed.SSFrame SSFramePiecesTab 
         Height          =   6885
         Left            =   -74730
         TabIndex        =   57
         Top             =   270
         ...
         _ExtentY        =   12144
         _Version        =   131074
         Begin Threed.SSFrame SSFramePieces 
            Height          =   2325
            Left            =   240
            TabIndex        =   58
            Top             =   300
            ...
            _ExtentY        =   4101
            _Version        =   131074
            Begin VB.TextBox txtTeamPieceBalance 
               Alignment       =   2  'Center
               DataField       =   "price"
               Enabled         =   0   'False
               BeginProperty Font 
            ...
            Begin VB.TextBox txtPrice 
               ...
               Width           =   2115
            End
            Begin VB.TextBox txtPiecesNotes 
               Alignment       =   1  'Right Justify
               DataField       =   "Notes"
               Height          =   405
               Left            =   420
            ...
            Begin VB.TextBox txtQty 
               ...
               Width           =   2115
            End
            Begin VB.TextBox txtFindPieceNo 
               Alignment       =   2  'Center
               Height          =   405
               Left            =   7050
               RightToLeft     =   -1  'True
            ...
            Begin VB.TextBox txtAmount 
               ...
               Width           =   2115
            End
            Begin MSDataListLib.DataCombo DcboPieces 
               DataField       =   "PieceNo"
               Height          =   405
               Left            =   2190
               TabIndex        =   61
               ...
               EndProperty
            End
            Begin MSDataListLib.DataCombo DcboPriceType 
               Bindings        =   "frmReparation_new.frx":0086
               Height          =   405
               Left            =   7050
               TabIndex        =   62
               Top             =   1230
            ...
            End
         End
         Begin MSHierarchicalFlexGridLib.MSHFlexGrid DgrdPieces 
            Height          =   2805
            Left            =   240
            TabIndex        =   70
            TabStop         =   0   'False
            ...
            _Band(0).Cols   =   2
         End
         Begin Threed.SSFrame SSFramePieceButtons 
            Height          =   765
            Left            =   1845
            TabIndex        =   76
            Top             =   2850
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Begin Threed.SSCommand CmdAddPiece 
               Height          =   450
               Left            =   5820
               TabIndex        =   65
               ToolTipText     =   "ÃœÌœ"
               ...
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               Picture         =   "frmReparation_new.frx":009C
            End
            Begin Threed.SSCommand CmdCancelPiece 
               Height          =   450
               Left            =   3570
               TabIndex        =   67
               ToolTipText     =   "«·€«¡ «·«„—"
               ...
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               Picture         =   "frmReparation_new.frx":01AE
            End
            Begin Threed.SSCommand CmdEditPiece 
               Height          =   450
               Left            =   2430
               TabIndex        =   68
               ToolTipText     =   " ⁄œÌ·"
               ...
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               Picture         =   "frmReparation_new.frx":02C0
               PictureAlignment=   8
            End
            Begin Threed.SSCommand CmdSavePiece 
               Height          =   450
               Left            =   4695
               TabIndex        =   66
               ToolTipText     =   "Õ›Ÿ"
               ...
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               Picture         =   "frmReparation_new.frx":0712
            End
            Begin Threed.SSCommand CmdDeletePiece 
               Height          =   450
               Left            =   1305
               TabIndex        =   69
               ToolTipText     =   "Õ–›"
               ...
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               Picture         =   "frmReparation_new.frx":0824
            End
         End
      End
      Begin Threed.SSFrame SSFrameRep 
         ...
         Begin MSDataListLib.DataCombo DcboRepClass 
            Bindings        =   "frmReparation_new.frx":0936
            Height          =   405
            Left            =   5910
            TabIndex        =   32
            TabStop         =   0   'False
      ...
      Begin Threed.SSFrame SSFrameRepInfo 
         ...
         Begin MSDataListLib.DataCombo DcboReparationStatus 
            Bindings        =   "frmReparation_new.frx":094C
            Height          =   405
            Left            =   2700
            TabIndex        =   13
            Top             =   690
         ...
         Begin MSDataListLib.DataCombo DcboPayMethod 
            Bindings        =   "frmReparation_new.frx":0962
            Height          =   405
            Left            =   7380
            TabIndex        =   10
            Top             =   3195
         ...
         Begin MSDataListLib.DataCombo DcboCliRecever 
            Bindings        =   "frmReparation_new.frx":0978
            Height          =   405
            Left            =   7380
            TabIndex        =   6
            Top             =   1185
      ...
      Begin Threed.SSCommand CmdSave 
         ...
         _Version        =   131074
         PictureFrames   =   1
         Picture         =   "frmReparation_new.frx":098E
         ButtonStyle     =   1
      End
      Begin Threed.SSCommand CmdDelete 
         ...
         _Version        =   131074
         PictureFrames   =   1
         Picture         =   "frmReparation_new.frx":16EF
         ButtonStyle     =   1
      End
   End
   ...
   End
End
Attribute VB_Name = "frmReparation_new"
...
Search TxtStkName, "costock", "StkName", "Stkno", True, SSTabRep.top, SSTabRep.left
...
ElseIf i = 2 Then
    ...
    With FlexGrid
        ...
        SetColWidths ColTotal, FlexGrid
    End With
End If
End Sub
